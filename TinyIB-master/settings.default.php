...
define('TINYIB_ADMINPASS', 'paumole123');       // Administrators have full access to the board
define('TINYIB_MODPASS', 'paumole1234');        // Moderators only have access to delete (and moderate if TINYIB_REQMOD is set) posts  ['' to disable]

// Board description and behavior
define('TINYIB_BOARD', '14bischan');          // Unique identifier for this board using only letters and numbers
define('TINYIB_BOARDDESC', '14bischan');      // Displayed at the top of every page
...
define('TINYIB_TRIPSEED', 'insira_algum_texto_aqui'); // Enter some random text  (used when generating secure tripcodes)
